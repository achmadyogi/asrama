...
@else
	...
	<div class="row">
		<div class="col-md-6">
			<span style="display: inline-block; width: 150px">Kamar</span>: {{$dataKamar->nama}} <br>
			<span style="display: inline-block; width: 150px">Gedung</span>: {{$dataGedung->nama}} <br>
			<span style="display: inline-block; width: 150px">Asrama</span>: {{$dataAsrama->nama}} <br>
			<span style="display: inline-block; width: 150px">Gender</span>: {{$dataKamar->gender}} <br>
		</div>
		<div class="col-md-6">
			<span style="display: inline-block; width: 150px">Kapasitas</span>: {{$dataKamar->kapasitas}} <br>
			...
			<span style="display: inline-block; width: 150px">Keterangan Kamar</span>: {{$dataKamar->keterangan}}<br>
		</div>
	</div><br>
	<p>Alokasi dilakukan berdasarkan periode tinggal sebelumnya ({{$dataPeriode->nama_periode}})</p>
	<form method="POST" action="{{route('inboundReg_approval')}}">
		...
		<input type="Hidden" name="id_kamar" value="{{$dataKamar->id_kamar}}">
