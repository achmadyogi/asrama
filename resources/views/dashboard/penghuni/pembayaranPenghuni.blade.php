...
@section('header_title','Penghuni | Pembayaran (Host-to-Host)')
@section('content')
<div class="container">
	<br><br>
	<div class="row">
		<div class="col-md-9">
			...
			<div id="content">
                ...
                <div class="sider_body" style="background-color: white; padding: 10px 15px 10px 15px;">
					<h4><b>Form Pembayaran Penghuni (Host-to-Host)</b></h4><hr>
					<div style="padding: 10px 15px 10px 15px;">
                        <form action="{{route('submit_pembayaran')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('tanggal_bayar') ? ' has-error' : '' }}">
                                <input id="tanggal_bayar" class="input" name="tanggal_bayar" type="date" value="{{old('tanggal_bayar')}}" placeholder="Tanggal Bayar" required><br>
