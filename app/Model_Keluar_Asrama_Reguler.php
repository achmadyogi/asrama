...
class Model_Keluar_Asrama_Reguler extends Model
{
    protected $table = 'keluar_asrama_reguler';
    protected $primaryKey = 'id_pendaftaran_reguler';

    public static function getSentRequest() {
    	$out = DB::table('daftar_asrama_reguler')
    	->where('id_user', Auth::user()->id)
    	->join('keluar_asrama_reguler', 'daftar_asrama_reguler.id_daftar', '=', 'keluar_asrama_reguler.id_pendaftaran_reguler')
    	->select(
            'id_daftar', 
            'daftar_asrama_reguler.tanggal_masuk as tanggal_awal', 
            'daftar_asrama_reguler.tanggal_keluar as tanggal_akhir', 
            'keluar_asrama_reguler.tanggal_keluar as tanggal_keluar', 
            'alasan_keluar', 
            'status_keluar')
    	->get();
    	return $out;
    ...
    public static function getProposedRequest() {
    	$out = DB::table('keluar_asrama_reguler')
     ...
     */
    protected $fillable = [
        'id_pendaftaran_reguler', 'tanggal_keluar', 'alasan_keluar', 'status_keluar',
    ];
}
