...
class Model_Pindah_Asrama_Non_Reguler extends Model
{
    protected $table = 'pindah_asrama_non_reguler';
    ...
    public static function getSentRequest() {
    	...
    	->join('pindah_asrama_non_reguler', 'daftar_asrama_non_reguler.id_daftar', '=', 'pindah_asrama_non_reguler.id_pendaftaran_non_reguler')
    	->select('id_daftar',
    ...
    public static function getProposedRequest() {
    	$out = DB::table('pindah_asrama_non_reguler')
     ...
     */
    protected $fillable = [
        'id_pendaftaran_non_reguler', 'alasan_pindah', 'status_pindah',
    ];
