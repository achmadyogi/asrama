...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
	{
	    ...
	    return view('admin.index', ['blacklist' => $blacklist]);
	}
	...
	public function update(Request $request) {
	    ...
	    if ($request->pengelola_check) {
	    	...
	    	$pengelola->id_asrama = $request->asrama == "Semua Asrama" ? 1 : $request->asrama;
	    	$pengelola->is_superpengelola = $request->asrama == "Semua Asrama" ? 1 : 0;
	    	$pengelola->save();
	    }
