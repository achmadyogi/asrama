        	...
        	$reguler = '0';
                ...
                foreach ($reguler as $reg) {
                        if(Kamar_penghuni::where(['daftar_asrama_id'=>$reg->id_daftar, 'daftar_asrama_type'=>'Daftar_asrama_reguler'])->count() > 0){
                                ...
                                // ambil data tagihan
                                $tagih = DB::select("SELECT * FROM tagihan WHERE daftar_asrama_id = :daftar_asrama_id AND daftar_asrama_type = :daftar_asrama_type", ['daftar_asrama_id'=>$reg->id_daftar, 'daftar_asrama_type'=>'Daftar_asrama_reguler']);
