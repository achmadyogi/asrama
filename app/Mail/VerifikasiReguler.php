...
class VerifikasiReguler extends Mailable
{
    ...
    public function build()
    {
        ...
        $date = Daftar_asrama_reguler::find($this->Reg->id_daftar);
        ...
        return $this->view('email.RegVerification')
                    ->with(['email'=>$email,
                            'nama'=>$nama,
                            'kamar'=>$kamar,
                            'gedung'=>$gedung,
